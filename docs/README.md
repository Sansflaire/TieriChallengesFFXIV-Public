...
| [Pending Verification](Pending%20Verification.md) | **Standing reminder list.** Everything Trist still needs to test in-game, decide, or build for Challenge Tokens — plus what has already been answered. Re-read at the start of any Tokens/quests session; nothing leaves it until done. | 2026-08-26 |
